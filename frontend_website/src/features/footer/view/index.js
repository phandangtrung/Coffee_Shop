          ...
          <Row style={{ textAlign: "start" }}>
            <Col className="footer-column" span={8}>
              ...
              <div className="detail">
                Mỗi ngày, chúng tôi đi làm với hi vọng thực hiện hai việc: chia
                sẻ ly cà phê tuyệt vời với bạn bè và giúp cho thế giới hoàn
                thiện hơn một chút. Điều đó đã thành sự thực khi cửa hàng
                Starbucks đầu tiên khai trương vào năm 1971 và ngày nay, điều đó
