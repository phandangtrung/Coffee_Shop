        ...
        return (
            <div className="Hompage">
                ...
                <Carousel autoplay  autoplaySpeed={3000}>
                    <div>
                    <h3 className="banner"><img alt={"slide1"}  src={Images.SLIDE1} className="reponsive-img" /></h3>
                    </div>
                    <div>
                    ...
                    <div>
                    <h3 className="banner"><img alt={"slide4"}  src={Images.SLIDE4}    className="reponsive-img" /></h3>
                    </div>
                </Carousel>               
            </div>
        )
